...
export default function Home(){
 return <main className="landing">
  <section className="hero">
   ...
   <div className="actions"><Link className="primary" href="/farmer">Espace Producteur</Link>
   <Link className="secondary" href="/buyer">Espace Acheteur</Link><Link className="secondary" href="/operations">Opérations</Link><Link className="secondary" href="/login">Se connecter</Link></div>
  </section>
